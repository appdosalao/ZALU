...
const Privacidade = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted p-responsive">
      <PageMeta
        title="Política de Privacidade — ZALU"
        description="Política de privacidade do ZALU em conformidade com a LGPD (Lei nº 13.709/2018). Saiba como tratamos seus dados."
        path="/privacidade"
      />
