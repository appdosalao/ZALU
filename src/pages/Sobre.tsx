...
const Sobre = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted p-responsive">
      <PageMeta
        title="Sobre o ZALU"
        description="O ZALU é um sistema de gestão completo para salões de beleza e profissionais autônomos: agenda, clientes, serviços, produtos e financeiro com LGPD."
        path="/sobre"
        jsonLd={{
      ...
      <Card className="w-full max-w-4xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-responsive-xl">ZALU</CardTitle>
