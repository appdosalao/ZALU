...
export declare const supabaseAdmin: import("@supabase/supabase-js").SupabaseClient<Database, "public", {
    Tables: {
        agendamentos: {
            Row: {
                cliente_id: string;
        ...
        clientes: {
            Row: {
                ...
                historico_servicos: import("../integrations/supabase/types.js").Json | null;
                id: string;
                nome: string;
                observacoes: string | null;
                telefone: string;
        ...
        logs_sistema: {
            Row: {
                ...
                id: string;
                ip_address: unknown;
                metadados: import("../integrations/supabase/types.js").Json | null;
                nivel: string;
                user_agent: string | null;
                user_id: string | null;
            };
        ...
        relatorios_auditoria: {
            Row: {
                ...
                estatisticas: import("../integrations/supabase/types.js").Json;
                id: string;
        ...
        vendas_produtos: {
            ...
            Relationships: [{
                foreignKeyName: "vendas_produtos_agendamento_id_fkey";
                columns: ["agendamento_id"];
                isOneToOne: false;
                referencedRelation: "agendamentos";
                referencedColumns: ["id"];
    ...
    Functions: {
        ...
        test_delete_permissions: {
            ...
            Returns: import("../integrations/supabase/types.js").Json;
        };
        testar_horarios_disponiveis: {
            ...
            Returns: {
                ...
                horario_abertura: string;
                horario_fechamento: string;
                horarios_disponiveis: import("../integrations/supabase/types.js").Json;
                user_email: string;
            }[];
        };
        validar_agendamento: {
