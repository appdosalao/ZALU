...
export declare const supabasePublic: import("@supabase/supabase-js").SupabaseClient<Database, "public", {
    Tables: {
        agendamentos: {
            Row: {
                cliente_id: string;
        ...
        clientes: {
            Row: {
                ...
                historico_servicos: import("./types").Json | null;
                id: string;
                nome: string;
                observacoes: string | null;
                telefone: string;
        ...
        logs_sistema: {
            Row: {
                ...
                id: string;
                ip_address: unknown;
                metadados: import("./types").Json | null;
                nivel: string;
                user_agent: string | null;
                user_id: string | null;
            };
        ...
        relatorios_auditoria: {
            Row: {
                ...
                estatisticas: import("./types").Json;
                id: string;
    ...
    Functions: {
        ...
        testar_horarios_disponiveis: {
            ...
            Returns: {
                ...
                horario_abertura: string;
                horario_fechamento: string;
                horarios_disponiveis: import("./types").Json;
                user_email: string;
            }[];
        };
        validar_agendamento: {
