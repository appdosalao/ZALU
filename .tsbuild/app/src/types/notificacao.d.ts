export type TipoNotificacao = 'novo_agendamento' | 'lembrete_agendamento' | 'retorno_cronograma' | 'despesa_fixa' | 'servico_finalizado';
...
export type Notificacao = NotificacaoAgendamento | NotificacaoRetorno | NotificacaoDespesa | NotificacaoServico;
...
//# sourceMappingURL=notificacao.d.ts.map